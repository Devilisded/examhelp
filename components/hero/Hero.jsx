				...
				<div className="grid w-[75%] py-8 mx-auto gap-8 lg:py-16 lg:grid-cols-5  ">
					<div className="mr-auto place-self-center  order-last lg:order-1 lg:col-span-3 z-10">
						<h1 className=" mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-4xl xl:text-6xl text-white">
							Get Yourself The Best Exam Help Support with Exam Help Online, &
							<span className=" text-orange-400"> Boost Your Grades!</span>
						</h1>
						<p className="mb-6 font-light lg:mb-8 md:text-lg lg:text-xl text-gray-300">
							Now, getting stressed due to exams is a matter of the past. Make
							the right decision like thousands of students worldwide by
							choosing our online exam help, and score high grades with the
							assistance of our highly experienced experts.
						</p>
						<ul className="list-none mb-4 font-light text-gray-300 md:text-lg lg:text-xl">
							...
							<li className="flex mb-1">
								<IconChecks className="me-2" /> Highly Experienced Experts (With
								a Minimum 5 Years Of Working Experience)
							</li>
							<li className="flex mb-1">
