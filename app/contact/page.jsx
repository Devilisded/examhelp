            ...
            <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-20">
                <div class="mb-4">
                    <div class="mb-2 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                        <h2 class="my-2 font-bold text-center text-5xl">Contact <span class="text-blue-700">Us</span>
                        </h2>
                    </div>
                </div>
                <div class="flex items-stretch">
                    <div class="grid md:grid-cols-2">
                        <div class="w-full ">
                            <p class=" p-5 mt-2 mb-2 text-lg text-gray-600 dark:text-slate-400">
                            Thank you for your interest in reaching out to us. Whether you have questions, feedback, or simply want to say hello, we're here to assist you. 
                            </p>
                            <div className="p-5">
                            <ul class="mb-1 md:mb-0">
                                <li class="flex">
                                    ...
                                    <div class="ml-4 mb-4">
                                        ...
                                        <p class="text-gray-600 dark:text-slate-400">2685 California Street, Mountain View </p>
                                        <p class="text-gray-600 dark:text-slate-400">CA 94040</p>
                                    </div>
                                </li>
                                <li class="flex">
                                    <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-700 text-gray-50">
                                    ...
                                    <div class="ml-4 mb-4">
                                        ...
                                        <p class="text-gray-600 dark:text-slate-400">Mobile: +91 9053000124</p>
                                        <p class="text-gray-600 dark:text-slate-400">Mail: info@examhelp.online</p>
                                    </div>
                                </li>
                                <li class="flex">
                                    <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-700 text-gray-50">
                        ...
                        <div class="card h-fit max-w-6xl p-5 md:p-12" id="form">
                            ...
                            <form id="contactForm">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="w-full bg-blue-700 text-white px-6 py-3 font-xl rounded-md sm:mb-0">Send Message</button>
                                </div>
                            </form>
                        </div>
                    </div>
