      ...
      <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-20">
        <div class="mb-4">
          <div class="mb-2 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
            <h2 class="my-2 font-bold text-center text-5xl">
              Contact <span class="text-blue-700">Us</span>
            </h2>
          </div>
        </div>
            ...
            <div class="card h-fit max-w-6xl p-5 md:p-12" id="form">
              ...
              <form id="contactForm" onSubmit={handleSubmit}>
                ...
                <div class="text-center">
                  <button
                    type="submit"
                    class="w-full bg-blue-700 text-white px-6 py-3 rounded-md sm:mb-0 flex gap-1 justify-center"
                  >
                    {load ? (
