...
const Aboutus = () => {
  return (
    <div>
      ...
      <ServiceHero title="Testing Dynamic Title for the service hero" desc="Now, getting stressed due to exams is a matter of the past. Make the
      ...
      <div class="items-center grid grid-cols-2 gap-4 pl-10 pr-10">
        <div class= " bg-white p-4">
          ...
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eligendi
            ...
            soluta labore! Expedita quas, nesciunt similique autem, sunt,
            doloribus pariatur maxime qui sint id enim. Placeat, maxime labore.
            Dolores ex provident ipsa impedit, omnis magni earum. . </p>


            <ul class="pl-0 mt-8 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:gap-y-5 space-y-5 lg:space-y-0 mb-5">
                <li class="flex items-start lg:col-span-1">
                    <div class="flex-shrink-0"><svg class="h-5 w-5 text-teal-400" fill="currentColor"
                            viewBox="0 0 20 20">
                ...
                <li class="flex items-start lg:col-span-1">
                    ...
                    <p class="ml-3 text-lg leading-5 text-gray-700 font-ttnorms text-left">Early access to upcoming
                ...
                <li class="flex items-start lg:col-span-1">
                    ...
                    <p class="ml-3 text-lg leading-5 text-gray-700 font-ttnorms text-left">Dedicated customer support
                    </p>
                </li>
            </ul>
        </div>
       ...
       <div class="bg-white p-4">
        ...
        <p class="text-slate-900">
          ...
          nisi. Donec sodales maximus justo, nec dictum lectus malesuada non. Sed auctor ultrices tellus non varius. Sed eu enim malesuada, fermentum mi eu, finibus velit. Nam quis blandit velit, vel vehicula neque. Etiam eu lorem suscipit, sollicitudin ante at, pharetra quam.
            </p>
        </div>
        <div class="bg-white p-4">
