      ...
      <div className="mt-5">
        ...
        <div>
          <div className="px-10 md:px-0 text-center md:text-left text-slate-600 font-sans font-normal m-5 text-xl mx-auto max-w-7xl pb-10">
            ...
            <br></br>
            <p>
            If you require more information or have any questions about our site's disclaimer, please feel free to email us at matlabassignmenthelp3@gmail.com.
            </p>
          </div>
        </div>
      </div>
